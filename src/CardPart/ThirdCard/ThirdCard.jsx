        ...
        <div className="modalCardContainer">
          ...
          <div className="thirdCardModalContent">
            ...
            <div className="cardModalText">
              <p>
                Si vous voulez ouvrir cette porte il va falloir rentrer le bon
                code.
              </p>
              <br />
            ...
            <div className="divcloseCardsButton">
              <button
                ...
                className="closeCardsButton"
              >
                Unclock
              </button>
            </div>
            <button onClick={toggleModal} className="fermeButton">
              Fermer
            </button>
          </div>
        </div>
      ...
      {winModal && (
        <div className="winModalContainer">
          ...
          <div className="winModalContent">
            <h2>🎉FÉLICITATION🎉</h2>
            <p className="Wintxt">
              vous-avez réussi à résoudre cette énigme qui ma foi était assez
              tricky. <br /> <br /> En espérant que ce test technique vous aura
              plu.{" "}
            </p>
            <a
              ...
              target="_blank"
            >
              https://www.linkedin.com/in/dimitri-fontenelle/
            </a>
          </div>
        </div>
      )}
